...
class Pong(Frame):
    ...
    def play(self):
        ...
        # Automated Paddle Movement Logic
    ...
    def build_menus(self, menu_bar, gameref):
        ...
        player_menu.add_radiobutton(label='Man Vs. Machine', variable=self.player_count_radio, value=1,
                                    command=gameref.change_player_count)
        player_menu.add_radiobutton(label='Multiplay', variable=self.player_count_radio, value=2,
                                    command=gameref.change_player_count)
